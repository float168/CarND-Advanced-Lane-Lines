...
The functions for calibrating camera and undistorting image are packed in `Undistorter` class, which code located between line 38 and line 71 of [pipeline.py](./pipeline.py).
Furthermore, the actual application of `Undistorter` is located in the the 1st and 3rd code cells of [demo.ipynb](./demo.ipynb).
...
For distortion correction, I simply use `undistorter.apply` to the image.
